...
@section('page-header')
                        <!-- PAGE-HEADER -->
                            <div>
                                <h1 class="page-title">Edit Heath Tips</h1>
                                <ol class="breadcrumb">
...
<a href="{{ route('dashboard.healthtips.index') }}#" class="btn btn-info-light ">
	...
	Back
                                ...
                                <form  method="post" action="{{route('dashboard.healthtips.edit' , $user->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('GET')
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control title" name="title" placeholder="title" value="{{ old('description', isset($user) ? $user->title : '') }}" required>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control description" name="description" placeholder="description" value="{{ old('description', isset($user) ? $user->description : '') }}" required>{{$user->description}}</textarea>
...
<div class="dropify-wrapper" style="height: 302px;border: 1px solid #cdcdcd;">
    ...
    @if(isset($user->image))
        ...
        <input type="file" class="dropify" data-height="300" data-default-file="{{asset('health/feature/'.$user->image)}}" name="image" value="">
