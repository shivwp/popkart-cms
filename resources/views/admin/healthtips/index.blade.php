                        ...
                        <!-- PAGE-HEADER -->
                            <div>
                                <h1 class="page-title">Health</h1>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#">Heath Tips</a></li>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
                        ...
                        <!-- ROW-1 OPEN-->
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <a href="{{ route('dashboard.healthtips.create') }}" class="btn btn-info-light ">
                                    Add Health Tips
                                </a>
                                            ...
                                            <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                                                ...
                                                <tbody id="tbody" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if($key->image != '')
                                                        <td><img src="{{url('health/feature').'/'.$key->image}}" alt="" style="height:50px"></td>
                                                        @else
                                                        <td>N/A</td>
                                                        @endif
                                                         <td>   
                                                            <a class="btn btn-sm btn-secondary" href="{{ route('dashboard.healthtips.show' , $key->id ) }}"><i class="fa fa-edit"></i> </a>
                                                            
                                                       
                                                            <form action="{{ route('dashboard.healthtips.destroy' , $key->id ) }}" method="POST" onsubmit="return confirm('Do You Want To Delete This ?');" style="display: inline-block;">
