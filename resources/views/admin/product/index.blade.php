...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
                                            ...
                                            <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                                                ...
                                                @if(count($product)>0)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="text-dark" href="{{ route('dashboard.product.edit', $item->id) }}">{{$item->pname ?? '' }}</a></td>
                                                    ...
                                                    <td>{{$item->title ?? '' }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <img src="{{$item->featured_image}}" alt="" style="height:50px">
                                                            @endif
                                                        </td>
                                                        <td>
                        ...
                        @can('product_edit')
                         <a class="btn btn-sm btn-success" href="{{ url('dashboard/update-product-approve' , $item->id )}}"><i class="fa fa-check"></i> </a>

                          <a class="btn btn-sm btn-warning" href="{{ url('dashboard/update-product-reject' , $item->id )}}"><i class="fe fe-x"></i> </a>
