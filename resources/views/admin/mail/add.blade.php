...
<div class="card">
   <div class="card-body">
      <form method="POST" action="{{ route('dashboard.mail.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select class="form-control select2" name="mail_cat">
                     ...
                     <option value="password_reset" {{isset($mail) && ($mail->msg_category == 'password_reset') ? 'selected' : '' }}>Password reset</option>
                     ...
                     <option value="signup_success" {{isset($mail) && ($mail->msg_category == 'signup_success') ? 'selected' : '' }}>Signup Success</option>
                     <option value="forget_password" {{isset($mail) && ($mail->msg_category == 'forget_password') ? 'selected' : '' }}>Forget Password</option>
                     <option value="giftcard" {{isset($mail) && ($mail->msg_category == 'giftcard') ? 'selected' : '' }}>Gift Card Code</option>
                     <option value="user_invitation" {{isset($mail) && ($mail->msg_category == 'user_invitation') ? 'selected' : '' }}>User Invitation</option>
                     <option value="subscription_plan_updated" {{isset($mail) && ($mail->msg_category == 'subscription_plan_updated') ? 'selected' : '' }}>Subscription Plan Updated</option>
                  </select>
               </div>
            </div>
            <div class="col-md-6">
         ...
         @if(isset($mail->id))
         <button class="btn btn-success-light mt-3 mx-3" type="submit">Update</button>
         @else
         <button class="btn btn-success-light mt-3 mx-3" type="submit">Save</button>
         @endif
      </form>
   </div>
</div>
