                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="store_name" placeholder="Name" value="{{ old('store_name', isset($user) ? $user->first_name : '') }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="address" placeholder="Address" value="{{ old('address', isset($user) ? $user->first_name : '') }}" required>
