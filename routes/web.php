...
Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.', 'middleware' => ['auth']], function (){
    ...
    Route::resource('pakage', PakageController::class);  
    ...
    Route::resource('healthtips', HealthTipsController::class);
    ...
    Route::get('update-product-count', [UsersController::class,'productcount'])->name('update-product-count');



    Route::get('update-product-approve/{id}', [ProductController::class,'productapprove'])->name('update-product-approve ,');



    Route::get('update-product-reject/{id}', [ProductController::class,'productreject'])->name('update-product-reject');
    ...
    Route::get('update-list-count', [UsersController::class,'listcount'])->name('update-list-count');
    ...
    Route::get('update-vendor-count', [UsersController::class,'vendorcount'])->name('update-vendor-count');
    ...
    Route::post('multi-product-add', [ListController::class,'addmulti'])->name('multi-product-add');
